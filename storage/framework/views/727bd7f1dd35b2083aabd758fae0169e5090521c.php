...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-secondary py-4">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <a class="nav-link active" href="<?php echo e(route('blog.index')); ?>">Blog</a>
    ...
    <div class="copyright py-4 text-center text-white">
        <div class="container">
            <small>
                Copyright Francesco Saverio Solofra
            </small>
        </div>
    </div>
    <!-- Footer -->
...
<?php /**PATH D:\PROGRAMMAZIONE\Progetti Laravel\onlineStore4\resources\views/app.blade.php ENDPATH**/ ?>